...
class TestMerging:
    ...
    @pytest.mark.parametrize("line_input,expected_output,expected_score", [
        # Basic merges
        ([2, 2, 0, 0], [4, 0, 0, 0], 4),
        ([4, 4, 0, 0], [8, 0, 0, 0], 8),
        ([8, 8, 0, 0], [16, 0, 0, 0], 16),
    ...
    def test_mixed_values_no_merge(self, game, line_input, expected_output, expected_score):
    ...
    def test_large_number_merging(self, game, line_input, expected_output, expected_score):
    ...
    @pytest.mark.parametrize("line_input,expected_score", [
        # Single merge scores
        ([2, 2, 0, 0], 4),
        ([4, 4, 0, 0], 8),
        ([16, 16, 0, 0], 32),
    ...
    def test_multiple_merges_in_line(self, game, line_input, expected_output, expected_score):
        """Test multiple merges occurring in a single line."""
        line = np.array(line_input[:4], dtype=int)  # Ensure we only take first 4 elements
        result, score = game._slide_line(line)
    ...
    def test_maximum_tile_merging(self, game, line_input, expected_output, expected_score):
    ...
    def test_empty_line_handling(self, game, line_input, expected_output, expected_score):
    ...
    @pytest.mark.parametrize("line_input,expected_output", [
        ...
        ([2, 0, 2, 2], [4, 2, 0, 0]),  # First and third merge to 4, fourth becomes 2
        ([4, 0, 4, 4], [8, 4, 0, 0]),
    ...
    def test_comprehensive_edge_cases(self, game, line_input, expected_output, expected_score):
